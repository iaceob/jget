...
public class SlxlmePlugin implements IPlugin {
    ...
    public boolean start() {
        // si.before();
        Boolean slxlmeStatus = SqlKit.init(this.folderPath, this.fileSuffix, this.expression, this.container, this.containerMark, this.sqlMark);
        // si.after();
        return slxlmeStatus;
    }
    ...
    /*
    public SlxlmeInterface getSi() {
        return si;
    }

    public void setSi(SlxlmeInterface si) {
        this.si = si;
    }
     */
